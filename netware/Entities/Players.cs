...
namespace NetWare
{
    public static class Players
    {
        ...
        public static Vector3 GetFeetPosition(PlayerController playerController)
        {
            ...
            var rightFoot = playerAnimator.GetBoneTransform(HumanBodyBones.RightFoot).transform.position;
            var leftFoot = playerAnimator.GetBoneTransform(HumanBodyBones.LeftFoot).transform.position;

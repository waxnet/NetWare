...
public static class AimbotSection
{
    ...
    private static void DrawTargeting()
    {
        ...
        // aim bone
        var aimBone = Menu.NewDropdown("Aim Bone", "AimBotAimBone", Config.Active.Aimbot.Bone.ConvertToString(), Aim.AimBones.Keys);
        Config.Active.Aimbot.Bone = Aim.AimBones[aimBone];

        // aim mode
        var aimMode = Menu.NewDropdown("Aim Mode", "AimBotAimMode", Config.Active.Aimbot.Mode.ConvertToString(), Aim.AimModes.Keys);
        Config.Active.Aimbot.Mode = Aim.AimModes[aimMode];

        // aim filter
        var aimFilter = Menu.NewDropdown("Filter By", "AimBotAimFilter", Config.Active.Aimbot.Filter.ConvertToString(), Aim.AimFilters.Keys);
        Config.Active.Aimbot.Filter = Aim.AimFilters[aimFilter];

...
namespace NetWare
{
    public static class Config
    {
        ...
        public static Dictionary<string, string> config = new Dictionary<string, string>()
        {
            ...
            ["combat.aimbot.filterby"] = "FOV",
            ["combat.aimbot.maxdistance"] = "500",
            ["combat.aimbot.mindistance"] = "0",
            ...
            ["combat.silentaim.filterby"] = "FOV",
            ["combat.silentaim.maxdistance"] = "500",
            ["combat.silentaim.mindistance"] = "0",
